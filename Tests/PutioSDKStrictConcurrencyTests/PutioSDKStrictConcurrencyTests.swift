...
final class PutioSDKStrictConcurrencyTests: XCTestCase {
  ...
  func testLowRiskValueTypesAreSendable() {
    ...
    requireSendable(PutioVideoPlaybackSource.self)
    requireSendable(PutioVideoPlaybackResolution.self)
    requireSendable(PutioVideoPlaybackResolutionError.self)
    requireSendable(PutioAudioPlaybackSource.self)
    requireSendable(PutioAudioPlaybackResolutionError.self)
    ...
    requireSendable(PutioDeviceCodeAuthorization.self)
    ...
    requireSendable(PutioFilesListContinueQuery.self)
...
private func auditAsyncConsumerSurface(_ sdk: PutioSDK) async throws {
  ...
  _ = try await sdk.resolveAudioPlaybackSource(fileID: 1)
